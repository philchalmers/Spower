...
#> t = 3.3905, df = 98, p-value = 0.001007
...
#> 95% Confidence Interval: [0.444, 0.464]
...
#> 
#> Estimate of n: 137.7
#> 95% Confidence Interval: [136.3, 139.2]
...
sapply(dat, mean)
#> [1] 0.005017958 0.499488176
sapply(dat, sd)
#> [1] 0.9975647 1.0008211
...
#> 95% Confidence Interval: [0.940, 0.945]
