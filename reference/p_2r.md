...
#> 
#> Comparison between r1.jk (y, x) = 0.4452 and r2.hm (y, x) = 0.4393
#> Difference: r1.jk - r2.hm = 0.0059
...
#> 
#> Estimate of power: 0.177
#> 95% Confidence Interval: [0.170, 0.185]
...
#> 
#> Estimate of n: 759.0
#> 95% Confidence Interval: [754.8, 763.2]
