...
#> 
#> Comparison between r1.jk (y, x) = 0.3386 and r2.hm (y, x) = 0.4627
#> Difference: r1.jk - r2.hm = -0.1242
...
#> 
#> Estimate of n: 762.9
#> 95% Predicted Confidence Interval: [751.8, 772.4]
