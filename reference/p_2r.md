...
#> 
#> Comparison between r1.jk (y, x) = 0.4233 and r2.hm (y, x) = 0.5897
#> Difference: r1.jk - r2.hm = -0.1664
...
#> 
#> Estimate of n: 760.4
#> 95% Confidence Interval: [746.9, 773.4]
#> Execution time (H:M:S): 00:01:06
