...
#> 
#> Comparison between r1.jk (y, x) = 0.599 and r2.hm (y, x) = 0.6965
#> Difference: r1.jk - r2.hm = -0.0975
...
#> 
#> Estimate of power: 0.167
#> 95% Confidence Interval: [0.160, 0.175]
...
#> 
#> Estimate of n: 764.6
#> 95% Confidence Interval: [756.0, 773.2]
