...
#> 
#> data:  tab
#> X-squared = 9.84, df = 3, p-value = 0.01998
#> 
...
#> 
#> Estimate of n: 80.0
#> 95% Confidence Interval: [79.2, 80.9]
#> Execution time (H:M:S): 00:00:18
...
#> 
#> Estimate of n: 79.4
#> 95% Confidence Interval: [78.9, 79.9]
...
#> 1    NA   0.1      0.05  0.95
#> 
#> Estimate of n: 1616.4
#> 95% Confidence Interval: [1601.0, 1628.9]
...
#> 
#> Estimate of n: 1610.1
#> 95% Confidence Interval: [1588.0, 1638.2]
#> Execution time (H:M:S): 00:00:08
