...
required, and therefore further information should be extracted from the analysis object to accommodate.
...
metric of the observed variables rather than a metricless effect size ratio, which in general should be more natural for data analysts to specify.
