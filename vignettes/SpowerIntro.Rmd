...
- The compliment of the hypothesis of interest ($H_1$) in the Bayesian setting ($P(\neg H_1|X)=1 - P(H_1|X)$, where $P(H_1|X)$ is the posterior probability supporting the hypothesis of interest), or a logical value indicating support for the alternative hypothesis was supported $H_1$.
...
along with threshold $\alpha$ (`alpha` in `Spower()`).
