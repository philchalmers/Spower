...
pertains to, the function `interval()` can be used directly. Hence, the following
definition is identical to the above example.
...
The output will still be presented in terms of the `NA` placeholder logic, however
in this case the user does not need to specify the `NA` explicitly as it is implied
from context.
