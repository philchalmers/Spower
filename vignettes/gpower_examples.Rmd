...
```
## 
## Replications: 50000;   RAM Used: 99.6 Mb;   
##  Conditions: n=649, d=0.1, type=one.sample, two.tailed=FALSE, sig.level=0.05
## 
...
## 95% Confidence Interval: [0.795, 0.802]
## 
## Replications: 50000;   RAM Used: 101.4 Mb;   
##  Conditions: n=164, d=0.2, type=one.sample, two.tailed=FALSE, sig.level=0.05
## 
...
## 
## Replications: 50000;   RAM Used: 103.5 Mb;   
##  Conditions: n=42, d=0.4, type=one.sample, two.tailed=FALSE, sig.level=0.05
## 
...
## 95% Confidence Interval: [0.793, 0.800]
## 
## Replications: 50000;   RAM Used: 105.6 Mb;   
##  Conditions: n=20, d=0.6, type=one.sample, two.tailed=FALSE, sig.level=0.05
## 
## Execution time (H:M:S): 00:00:16
## Design conditions: 
## 
...
## 95% Confidence Interval: [0.806, 0.813]
## 
## Replications: 50000;   RAM Used: 107.7 Mb;   
##  Conditions: n=12, d=0.8, type=one.sample, two.tailed=FALSE, sig.level=0.05
## 
...
## 
## Replications: 50000;   RAM Used: 109.8 Mb;   
##  Conditions: n=9, d=1, type=one.sample, two.tailed=FALSE, sig.level=0.05
## 
## Execution time (H:M:S): 00:00:15
## Design conditions: 
## 
...
## 95% Confidence Interval: [0.843, 0.849]
```
...
```
## 
## Replications: 50000;   RAM Used: 125.7 Mb;   
##  Conditions: n=419, d=0.1, type=one.sample, corrct=FALSE, tw.tld=FALSE, sg.lvl=0.05
## 
...
##       n     d type       correct two.tailed sig.level power
##   <dbl> <dbl> <chr>      <lgl>   <lgl>          <dbl> <lgl>
## 1   419   0.1 one.sample FALSE   FALSE           0.05 NA   
## 
## Estimate of power: 0.802
## 95% Confidence Interval: [0.798, 0.805]
## 
## Replications: 50000;   RAM Used: 127.6 Mb;   
##  Conditions: n=109, d=0.2, type=one.sample, corrct=FALSE, tw.tld=FALSE, sg.lvl=0.05
## 
...
##       n     d type       correct two.tailed sig.level power
##   <dbl> <dbl> <chr>      <lgl>   <lgl>          <dbl> <lgl>
## 1   109   0.2 one.sample FALSE   FALSE           0.05 NA   
## 
## Estimate of power: 0.801
## 95% Confidence Interval: [0.798, 0.805]
## 
## Replications: 50000;   RAM Used: 129.9 Mb;   
##  Conditions: n=31, d=0.4, type=one.sample, corrct=FALSE, tw.tld=FALSE, sg.lvl=0.05
## 
## Execution time (H:M:S): 00:00:18
## Design conditions: 
## 
...
##       n     d type       correct two.tailed sig.level power
##   <dbl> <dbl> <chr>      <lgl>   <lgl>          <dbl> <lgl>
## 1    31   0.4 one.sample FALSE   FALSE           0.05 NA   
## 
## Estimate of power: 0.803
## 95% Confidence Interval: [0.799, 0.806]
## 
## Replications: 50000;   RAM Used: 132.2 Mb;   
##  Conditions: n=16, d=0.6, type=one.sample, corrct=FALSE, tw.tld=FALSE, sg.lvl=0.05
## 
## Execution time (H:M:S): 00:00:18
## Design conditions: 
## 
...
##       n     d type       correct two.tailed sig.level power
##   <dbl> <dbl> <chr>      <lgl>   <lgl>          <dbl> <lgl>
## 1    16   0.6 one.sample FALSE   FALSE           0.05 NA   
## 
## Estimate of power: 0.798
## 95% Confidence Interval: [0.794, 0.801]
## 
## Replications: 50000;   RAM Used: 134.5 Mb;   
##  Conditions: n=11, d=0.8, type=one.sample, corrct=FALSE, tw.tld=FALSE, sg.lvl=0.05
## 
## Execution time (H:M:S): 00:00:18
## Design conditions: 
## 
...
## 
## Replications: 50000;   RAM Used: 136.9 Mb;   
##  Conditions: n=8, d=1, type=one.sample, corrct=FALSE, tw.tld=FALSE, sg.lvl=0.05
## 
## Execution time (H:M:S): 00:00:17
## Design conditions: 
## 
...
##       n     d type       correct two.tailed sig.level power
##   <dbl> <dbl> <chr>      <lgl>   <lgl>          <dbl> <lgl>
## 1     8     1 one.sample FALSE   FALSE           0.05 NA   
## 
## Estimate of power: 0.774
## 95% Confidence Interval: [0.770, 0.777]
```
