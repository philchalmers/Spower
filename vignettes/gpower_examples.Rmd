...
## 1    95   0.1     5      0.05 NA   
## 
## Estimate of power: 0.672
## 95% Confidence Interval: [0.663, 0.682]
```
...
## 
## Estimate of n: 242.6
## 95% Prediction Interval: [240.4, 244.7]
```
...
## 
## Estimate of power: 0.763
## 95% Confidence Interval: [0.755, 0.772]
```
...
## 
## Estimate of n: 38.2
## 95% Prediction Interval: [37.5, 39.1]
```
...
## 
## Estimate of n: 79.5
## 95% Prediction Interval: [78.7, 80.4]
```
...
## 
## Estimate of n: 192.8
## 95% Prediction Interval: [191.3, 194.4]
```
...
## 
## Estimate of n: 85.3
## 95% Prediction Interval: [83.3, 88.3]
```



G\*power estimate is 88 per group, `Spower` estimate is 85.3418 with the 95% CI [83.3491, 88.2702].
...
## 
## Estimate of power: 0.842
## 95% Confidence Interval: [0.835, 0.849]
```
...
## 
## Estimate of n: 29.4
## 95% Prediction Interval: [28.8, 30.0]
```
...
## 
## Estimate of n: 1486.3
## 95% Prediction Interval: [1469.8, 1500.3]
```
...
## 1   649   0.1 one.sample FALSE           0.05 NA   
## 
## Estimate of power: 0.791
## 95% Confidence Interval: [0.783, 0.799]
```
...
## 1    67 0.375      0.05 NA   
## 
## Estimate of power: 0.849
## 95% Confidence Interval: [0.842, 0.856]
```
