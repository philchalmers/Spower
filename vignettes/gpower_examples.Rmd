...
## 95% Prediction Interval: [1856.2, 1927.0]
```
...
## 
## Estimate of n: 466.7
## 95% Prediction Interval: [460.5, 470.8]
```
...
## 
## Estimate of n: 38.7
## 95% Prediction Interval: [38.0, 39.4]
```
...
## 
## Estimate of n: 86.8
## 95% Prediction Interval: [85.5, 88.5]
```



G\*power estimate is 88 per group, `Spower` estimate is 86.8473 with the 95% CI [85.4576, 88.4678].
...
## 
## Estimate of n: 29.4
## 95% Prediction Interval: [28.4, 30.7]
```
...
## 95% Prediction Interval: [1469.1, 1501.3]
```
...
![plot of chunk wilcox](figure/wilcox.png)
