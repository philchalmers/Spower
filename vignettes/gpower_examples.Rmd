...
## 
## Estimate of power (1 - beta): 0.420
## 95% Confidence Interval: [0.410, 0.430]
```
...
``` r
parent <- function(n, d) VGAM::rlaplace(n)/SD + d
...
## 
## # A tibble: 1 × 7
##       n     d parent1 type       two.tailed sig.level power
##   <dbl> <dbl> <list>  <chr>      <lgl>          <dbl> <dbl>
## 1    11   0.8 <fn>    one.sample FALSE           0.05    NA
## 
## Estimate of power (1 - beta): 0.810
...
## 
## Estimate of power (1 - beta): 0.839
## 95% Confidence Interval: [0.835, 0.843]
```
...
## 
## Estimate of power (1 - beta): 0.878
## 95% Confidence Interval: [0.872, 0.885]
```
...
## 
## Estimate of power (1 - beta): 0.660
...
## 1    95   0.1     5      0.05    NA
## 
## Estimate of power (1 - beta): 0.667
...
## 
## Estimate of power (1 - beta): 0.240
## 95% Confidence Interval: [0.231, 0.248]
```
...
## 
## Estimate of n: 242.7
## 95% Prediction Interval: [240.6, 245.0]
```
...
## 
## Estimate of power (1 - beta): 0.756
...
## 
## Estimate of n: 38.7
## 95% Prediction Interval: [38.0, 39.3]
```
...
## 
## Estimate of Type I error rate (alpha/sig.level): 0.161
## Estimate of Type II error rate (beta): 0.161
## 95% Confidence Interval: [0.157, 0.165]
## 
## Estimate of power (1-beta): 0.839
## 95% Confidence Interval: [0.835, 0.843]
```
...
## 
## Estimate of n: 79.6
## 95% Prediction Interval: [78.8, 80.5]
```
...
## 
## Estimate of n: 194.1
## 95% Prediction Interval: [192.5, 195.6]
```
...
## 
## Estimate of n: 85.6
## 95% Prediction Interval: [83.9, 87.2]
```

G\*power estimate is 88 per group, `Spower` estimate is 85.5567 with the 95% CI [83.9461, 87.1854].
...
## 
## Estimate of power (1 - beta): 0.836
...
## 
## Estimate of n: 29.5
## 95% Prediction Interval: [28.2, 30.9]
```
...
## 
## Estimate of n: 1491.6
## 95% Prediction Interval: [1468.5, 1510.5]
```
...
## 1   649   0.1 one.sample FALSE           0.05    NA
## 
## Estimate of power (1 - beta): 0.798
## 95% Confidence Interval: [0.790, 0.806]
```
...
## 
## Estimate of power (1 - beta): 0.223
## 95% Confidence Interval: [0.215, 0.231]
```
