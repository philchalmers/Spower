...
## 95% Prediction Interval: [1856.2, NA]
```
...
## 
## Estimate of n: 138.1
## 95% Prediction Interval: [134.2, 142.1]
```
...
## 
## Estimate of n: 463.6
## 95% Prediction Interval: [461.5, 465.8]
```
...
## 
## Estimate of power (1 - beta): 0.408
## 95% Confidence Interval: [0.398, 0.417]
```
...
## 
## Estimate of power (1 - beta): 0.837
## 95% Confidence Interval: [0.832, 0.841]
```
...
## 
## Estimate of power (1 - beta): 0.886
## 95% Confidence Interval: [0.880, 0.892]
```
...
## 
## Estimate of power (1 - beta): 0.665
## 95% Confidence Interval: [0.656, 0.674]
```
...
## 1    95   0.1     5      0.05    NA
## 
## Estimate of power (1 - beta): 0.662
## 95% Confidence Interval: [0.653, 0.671]
```
...
## 
## Estimate of power (1 - beta): 0.234
## 95% Confidence Interval: [0.225, 0.242]
```
...
## 
## Estimate of n: 241.8
## 95% Prediction Interval: [239.5, 244.0]
```
...
## 
## Estimate of power (1 - beta): 0.761
...
## 
## Estimate of n: 38.7
## 95% Prediction Interval: [38.1, 39.3]
```
...
## 95% Confidence Interval: [0.156, 0.165]
## 
## Estimate of power (1-beta): 0.840
## 95% Confidence Interval: [0.835, 0.844]
```
...
## 
## Estimate of n: 79.6
## 95% Prediction Interval: [79.0, 80.2]
```
...
## 
## Estimate of n: 192.4
## 95% Prediction Interval: [188.6, 195.6]
```
...
## 
## Estimate of n: 85.9
## 95% Prediction Interval: [83.2, 89.2]
```



G\*power estimate is 88 per group, `Spower` estimate is 85.9173 with the 95% CI [83.2208, 89.179].
...
## 
## Estimate of n: 28.7
## 95% Prediction Interval: [28.2, 29.3]
```
...
## 
## Estimate of n: 1480.4
## 95% Prediction Interval: [1469.9, 1492.5]
```
