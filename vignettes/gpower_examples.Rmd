...
Power associated with the hypotheses 
$$H_0:\, \rho-\rho_0=0$$
$$H_1:\, \rho-\rho_0\ne 0$$
...
## Two dependent proportions test (McNemar's test)
...
Fixing $n=200$ and performing a compromise analysis assuming $q=\frac{\beta}{\alpha}=1$,

```{r}
## FIXME "Error in uniroot(compromise_root, c(1e-04, 0.9999), beta_alpha = beta_alpha,  : 
##  f() values at end points not of opposite sign
Spower(p_anova.test, n=200, k=10, f=.25, beta_alpha=1)
```
