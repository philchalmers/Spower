...
Unlike the previous section, this is the more cannonical version of the hypotheses involving correlation coefficients. Power associated with $\rho = .3$ with 100 pairs of observations, tested against $\rho_0=0$.
...
### Correlation - inequality of two independent Pearson r’s (Example 27.3)
...
## Fixed effects ANOVA - one way (Example 10.3)
...
## One-sample test with normal distribution (Example 22.3)
