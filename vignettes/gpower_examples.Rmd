...
Hence, the same null hypothesis can be evaluated using this augmented model testing the null
$$H_0:\, \beta_3 = 0$$
...
## 
## Estimate of n: 81.0
## 95% Prediction Interval: [80.0, 81.8]
```
...
## 
## Estimate of n: 194.1
## 95% Prediction Interval: [192.0, 196.2]
```
...
## 
## Estimate of n: 84.7
## 95% Prediction Interval: [83.5, 85.8]
```



G\*power estimate is 88 per group, `Spower` estimate is 84.7036 with the 95% CI [83.5452, 85.7846].
...
## 95% Confidence Interval: [0.832, 0.847]
```
...
## 
## Estimate of n: 29.0
## 95% Prediction Interval: [28.3, 30.0]
```
...
## 
## Estimate of n: 1494.6
## 95% Prediction Interval: [1473.2, 1517.3]
```
...
## 1   649   0.1 one.sample FALSE           0.05 NA   
## 
## Estimate of power: 0.790
## 95% Confidence Interval: [0.782, 0.798]
```
