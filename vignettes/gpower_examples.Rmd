...
```{r}
Spower(p_t.test, n=NA, d=.625, power=.95, two.tailed=FALSE, type='one.sample', interval=c(10, 100), verbose=FALSE)
```
...
```{r}
Spower(p_t.test, n=NA, d=.1, power=.9, type='one.sample', sig.level=.01, interval=c(100,2000), verbose=FALSE)
```
