...
With this approach, the five power analysis criteria described in `help(Spower)` are  entirely possible, and therefore solving other components (such as the sample size `n`) are easy to setup by providing suitable `NA` argument flags.
