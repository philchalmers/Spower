...
```{r}
Spower(p_lm.R2, n=95, R2=.1, k=5, fixed.X=FALSE)
```
...
```{r}
Spower(p_lm.R2, n=90, R2=.3, k=9, R2_0=.25, k.R2_0=5, sig.level=.01)
```

G\*power gives $1-\beta = .241$. Solving the sample size to achieve 80% power

```{r}
Spower(p_lm.R2, n=NA, R2=.3, R2_0 = .25, k=9, k.R2_0=5,
...
```{r}
Spower(p_lm.R2, n=200, R2=.16, R2_0 = .1, k=12, 
