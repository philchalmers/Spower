...
#
# }
# SpowerCluster <- function(spec, remove = FALSE, verbose=TRUE, ...){
...
# 		if(!is.null(.SpowerClusterEnv$SPOWERCLUSTER)){
# 			if(verbose)
# 				message(sprintf('Using previous cluster definition with %i workers ... ',
# 								length(.SpowerClusterEnv$SPOWERCLUSTER)))
