---
title: "Spower with experiments that return logical vectors"
...
output: 
  bookdown::html_document2:
    ...
    toc: true
vignette: >
  %\VignetteIndexEntry{Spower with experiments that return logical vectors}
...
```{r}
# these are equivalent power evaluations of "equivalence tests" 
l_equiv.t_CI(100, delta=1, equiv=c(-2.5, 2.5), 
		  sds=c(2.5, 2.5)) |> Spower()   
```
